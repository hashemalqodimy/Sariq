cp app/src/main/java/com/example/ui/screens/NewReportScreen.kt.bak app/src/main/java/com/example/ui/screens/NewReportScreen.kt || true
        ...
        for (report in localReports) {
            try {
                ...
                val reportMap = hashMapOf(
                    ...
                    "lostLocation" to report.lostLocation,
                    "lostGovernorate" to report.lostGovernorate,
            ...
            for (doc in snapshot.documents) {
                reports.add(
                    PhoneReport(
                        ...
                        lostLocation = doc.getString("lostLocation") ?: "",
                        lostGovernorate = doc.getString("lostGovernorate") ?: "",
                        rewardAmount = doc.getString("rewardAmount") ?: "",
